...
export const filmProjects: Record<'documentary' | 'narrative', FilmProject[]> = {
  documentary: [
    ...
    { title: 'Dahomey and Vodun', releaseDate: '', thumbnail: '/media/Danhomey-thumb.jpg', link: 'https://youtu.be/G93TsdYFgoY?si=ioxlIMvEAAF_-6A9', previewUrl: 'https://www.youtube-nocookie.com/embed/G93TsdYFgoY?autoplay=1&mute=1&controls=0&loop=1&playlist=G93TsdYFgoY' },
    { title: 'Revolution Now', releaseDate: '', thumbnail: '', link: 'https://vimeo.com/647411793', previewUrl: '' },
  ],
  narrative: [
